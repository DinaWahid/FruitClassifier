...
train_dataset = 'datasets/fruits/Train'
test_dataset = 'datasets/fruits/Test'
...
checkpoint = ModelCheckpoint("models/fruits-classifier-model.h5",
                             monitor="val_loss",
                             mode="min",
                             save_best_only=True,
                             verbose=1)
...
#training the model
nb_train_samples = 7649
nb_validation_samples = 2581
epochs = 15
